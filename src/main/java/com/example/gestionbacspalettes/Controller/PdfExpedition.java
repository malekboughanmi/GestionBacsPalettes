...
@RestController
@RequestMapping("/Api2")
public class PdfExpedition {



    @PostMapping(value = "/OpenPdf", produces = MediaType.APPLICATION_PDF_VALUE)
    public ResponseEntity<byte[]> OpenPdf() throws IOException, DocumentException, SQLException {
        ...
        Paragraph paragraph = new Paragraph("Expedition", fontTitle);
        ...
        while (rs.next()) {
            ...
            Mouvement reception = new Mouvement( bl, quantite);
        ...
        headers.setContentDispositionFormData("inline", "Expedition.pdf");
